...
%                  millimol/liter(?).
%   'Opdist'     - optode (source-detector) distance in cm (default 3)
...
%                  distance travelled by photons, default [7.25 6.38]
%  
% Returns:
...
props={'Citation'   1             'INT'
        ...
        'DPF'       [5.98 7.15]   'DOUBLE' % lambda 1 > lambda 2
        'Epsilon'   []            'DOUBLE'
        'Verbose'   0             'BOOL'};
...
% e=...looks like this
%               oxy-Hb         deoxy-Hb
% higherWL: 830 | e: 0.974       0.693            850   1.058	0.691
% lowerWL : 690 | e: 0.35         2.1             760   0.586	1.549
...
dat.clab = strrep(dat.clab, 'lowWL', 'oxy');
