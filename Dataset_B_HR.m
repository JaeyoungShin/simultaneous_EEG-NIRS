% This MATLAB script can be used to reproduce the hemodynamic response in dataset B (Figure 9)
...
plot_scalpEvolutionPlusChannel(epo_all.deoxy, mnt_dsr, {'AF2','CCP3'}, ival_scalp, defopt_scalp_erp, 'GlobalCLim', 0, 'Extrapolation', 0, 'Contour', 0, 'printival', 1, 'YUnit', 'mmol/L', 'Colormap', cmap_posneg(101), 'ColorOrder', [0 0 1], 'yLim', ylim, 'CLim', [-3 3]*1e-4, 'PlotStat', 'sem'); 
fig_set(4, 'Toolsoff', 0);
plot_scalpEvolutionPlusChannel(epo_all.oxy, mnt_dsr, {'AF2','CCP3'}, ival_scalp, defopt_scalp_erp, 'GlobalCLim', 0, 'Extrapolation', 0, 'Contour', 0, 'printival', 1, 'YUnit', 'mmol/L', 'Colormap', cmap_posneg(101), 'ColorOrder', [1 0 0], 'yLim', ylim, 'CLim', [-8 8]*1e-4, 'PlotStat', 'sem');
